...
class VirtualItems {
	...
	VITEMMACRO(fuelFull, "STR_Item_FuelF", "fuelFull", 4, 850, 500, false, -1, "icons\ico_fuel.paa")
	...
	VITEMMACRO(bottledbeer, "STR_Item_BottledBeer","bottledbeer",2,6000,4000,false,-1,"icons\beer.paa")
	...
	VITEMMACRO(speedbomb, "STR_Item_SpeedBomb","speedbomb",5,10000,75,true,-1,"icons\ico_speedbomb.paa")
	VITEMMACRO(ziptie, "STR_Item_ZipTie","ziptie",1,300,75,false,-1,"")
	...
	VITEMMACRO(copper_unrefined, "STR_Item_CopperOre", "copperUnrefined", 4, -1, -1, false, -1, "icons\ico_copperore.paa")
	VITEMMACRO(copper_refined, "STR_Item_CopperIngot", "copperRefined", 3, -1, 2200, false, -1, "icons\ico_copperingot.paa")
