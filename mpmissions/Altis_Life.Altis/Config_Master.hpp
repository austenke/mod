...
class VirtualItems {
	...
	VITEMMACRO(goldbar, "STR_Item_GoldBar", "goldBar", 12, -1, 125000, false, -1, "")
	...
	VITEMMACRO(salt_refined, "STR_Item_SaltR", "saltRefined", 1, -1, 4350, false, -1, "")
	VITEMMACRO(sand, "STR_Item_Sand", "sand", 3, -1, -1, false, -1, "")
	VITEMMACRO(glass, "STR_Item_Glass", "glass", 1, -1, 4300, false, -1, "")
	VITEMMACRO(diamond_uncut, "STR_Item_DiamondU", "diamondUncut", 4, -1, 750, false, -1, "")
	VITEMMACRO(diamond_cut, "STR_Item_DiamondC", "diamondCut", 2, -1, 11000, false, -1, "")
	VITEMMACRO(rock, "STR_Item_Rock", "rock", 6, -1, -1, false, -1, "")
	VITEMMACRO(cement, "STR_Item_CementBag", "cement", 5, -1, 2200, false, -1, "")

	//Drugs
	VITEMMACRO(heroin_unprocessed, "STR_Item_HeroinU", "heroinUnprocessed", 6, -1, -1, true, -1, "")
	VITEMMACRO(heroin_processed, "STR_Item_HeroinP", "heroinProcessed", 4, 5800, 2560, true, -1, "")
...
class Licenses {
	...
	LICENSEMACRO(Jet training,"STR_License_Jet","jet",5000000,false,"civ")
};
