...
class VirtualItems {
	...
	VITEMMACRO(bottledshine, "STR_Item_BottledShine","bottledshine",4,12500,17000,true,-1,"")
	VITEMMACRO(bottledwhiskey, "STR_Item_BottledWhiskey","bottledwhiskey",4,8000,5000,false,-1,"")
	VITEMMACRO(bottledbeer, "STR_Item_BottledBeer","bottledbeer",4,6000,4000,false,-1,"icons\beer.paa")
	VITEMMACRO(moonshine, "STR_Item_Moonshine","moonshine",4,8000,7000,true,-1,"")
	VITEMMACRO(whiskey, "STR_Item_Whiskey","whiskey",4,5000,4500,false,-1,"")
	VITEMMACRO(beerp, "STR_Item_Beerp","beerp",4,5000,4500,false,-1,"")
	VITEMMACRO(rye, "STR_Item_Rye","rye",3,2500,2000,false,-1,"")
	VITEMMACRO(hops, "STR_Item_Hops","hops",3,2000,1800,false,-1,"")
	VITEMMACRO(yeast, "STR_Item_Yeast","yeast",3,2100,2000,false,-1,"")
	VITEMMACRO(cornmeal, "STR_Item_Cornmeal","cornmeal",3,500,200,false,-1,"")
	VITEMMACRO(mash, "STR_Item_Mash","mash",3,500,200,false,-1,"")
	...
	VITEMMACRO(copper_refined, "STR_Item_CopperIngot", "copperRefined", 5, -1, 2200, false, -1, "icons\ico_copperingot.paa")
	VITEMMACRO(iron_unrefined, "STR_Item_IronOre", "ironUnrefined", 4, -1, -1, false, -1, "icons\ico_unrefined_iron.paa")
	VITEMMACRO(iron_refined, "STR_Item_IronIngot", "ironRefined", 3, -1, 3350, false, -1, "icons\ico_iron.paa")
	...
	VITEMMACRO(glass, "STR_Item_Glass", "glass", 3, -1, 4300, false, -1, "icons\ico_glass.paa")
	...
	VITEMMACRO(heroin_processed, "STR_Item_HeroinP", "heroinProcessed", 5, 5800, 2560, true, -1, "icons\ico_heroinp.paa")
	VITEMMACRO(cannabis, "STR_Item_Cannabis", "cannabis", 5, -1, -1, true, -1, "icons\ico_cannabis.paa")
	VITEMMACRO(marijuana, "STR_Item_Marijuana", "marijuana", 4, 4000, 2350, true, -1, "icons\ico_marijuana.paa")
	VITEMMACRO(cocaine_unprocessed, "STR_Item_CocaineU", "cocaineUnprocessed", 7, -1, 3000, true, -1, "icons\ico_cocaineup.paa")
	VITEMMACRO(cocaine_processed, "STR_Item_CocaineP", "cocaineProcessed", 6, 14000, 11000, true, -1, "icons\ico_cocainep.paa")
...
class Licenses {
	...
	LICENSEMACRO(sand,"STR_License_Sand","sand",500000,false,"civ")
