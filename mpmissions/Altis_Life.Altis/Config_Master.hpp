...
class VirtualItems {
	...
	VITEMMACRO(goldbar, "STR_Item_GoldBar", "goldBar", 50, -1, 125000, false, -1, "")
	...
	VITEMMACRO(copper_refined, "STR_Item_CopperIngot", "copperRefined", 3, -1, 2200, false, -1, "")
	VITEMMACRO(iron_unrefined, "STR_Item_IronOre", "ironUnrefined", 4, -1, -1, false, -1, "")
	VITEMMACRO(iron_refined, "STR_Item_IronIngot", "ironRefined", 3, -1, 3350, false, -1, "")
	VITEMMACRO(salt_unrefined, "STR_Item_Salt", "saltUnrefined", 5, -1, -1, false, -1, "")
	VITEMMACRO(salt_refined, "STR_Item_SaltR", "saltRefined", 4, -1, 4350, false, -1, "")
	VITEMMACRO(sand, "STR_Item_Sand", "sand", 4, -1, -1, false, -1, "")
	VITEMMACRO(glass, "STR_Item_Glass", "glass", 3, -1, 4300, false, -1, "")
	VITEMMACRO(diamond_uncut, "STR_Item_DiamondU", "diamondUncut", 8, -1, 750, false, -1, "")
	...
	VITEMMACRO(heroin_processed, "STR_Item_HeroinP", "heroinProcessed", 5, 5800, 2560, true, -1, "")
	...
	VITEMMACRO(cocaine_unprocessed, "STR_Item_CocaineU", "cocaineUnprocessed", 7, -1, 3000, true, -1, "")
	VITEMMACRO(cocaine_processed, "STR_Item_CocaineP", "cocaineProcessed", 6, -1, 11000, true, -1, "")
