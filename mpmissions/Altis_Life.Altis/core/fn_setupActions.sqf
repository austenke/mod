...
switch (playerSide) do {
	case civilian: {
		// Blow up big boi
		life_actions = life_actions + [player addAction["<t color='#FFCC00'>Blow Up!</t>",life_fnc_suicideVest,"",0,false,false,"",' player isKindOf "Man" && alive player && vest player == "V_HarnessOGL_gry" && !(player getVariable "restrained") ']];
		//Drop fishing net
