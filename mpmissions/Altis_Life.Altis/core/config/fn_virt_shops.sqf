...
switch (_shop) do
{
	...
	case "rebel": {["Rebel Market",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","ziptie","peach","boltcutter","blastingcharge","burlapsack","defib","speedbomb","ziptie"]]};
