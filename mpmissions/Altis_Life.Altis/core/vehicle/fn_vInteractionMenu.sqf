...
if(("ToolKit" in (items player) && (damage _curTarget < 1)) || playerSide == west) then {_Btn1 ctrlEnable true;} else {_Btn1 ctrlEnable false;};
...
if(playerSide == west) then {
	...
	_Btn6 buttonSetAction "[player,life_vInact_curTarget] remoteExecCall [""TON_fnc_seizeVehicle"",RSERV];";
